...
| [`0x1A-hash_tables`](https://github.com/risecodesleep/alx-low_level_programming/tree/master/0x1A-hash_tables) | This project focuses on hashing by implementing hash functions and hash tables with **C language**. |
